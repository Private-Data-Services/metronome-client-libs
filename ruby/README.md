...
PDS Metronome - the Ruby gem for the Metronome API
...
```shell
gem install pds-metronome-0.1.0.gem
```

or add this to your Gemfile:

```
gem 'pds-metronome', '~> 0.1.0'
```
...
(for development, run `gem install --dev ./pds-metronome-0.1.0.gem` to install the development dependencies)
